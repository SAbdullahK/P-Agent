...
#     raise ValueError("Google API is not found in your .env file. Please add it to your .env file")
...
#         try:
#             prompt = f"Here is a user query{user_query}\n\n"f"Here is the youtube video Transcript {video_transcript}\n\n"f"Generate a social media post for {social_media_platform} according to the provide transcript"
...
#     print("Social Media Post Generater")
#     video_id = input("Enter YouTube video ID: ").strip()
#     platform = input("Enter platform (LinkedIn, Instagram, Facebook, Twitter(X): ").strip()
#     user_query = input("Enter your query (e.g, 'Generate a LinkedIn post about this video': ").strip()

#     if not video_id or not user_query:
#         print("Please enter the YouTube video ID")
#     else:
#         Post = run_agent(video_id, platform, user_query)
